...
const normalizeTask = (task) => {
  ...
  if (
    task.assignees_detail &&
    Array.isArray(task.assignees_detail) &&
  ...
  return {
    ...
    createdByName:
      task.created_by_name || task.created_by?.full_name || task.createdByName || 'System',

    // Normalize department field
    departmentName:
      task.department_name || task.department?.name || task.departmentName || 'Not specified',
...
export const tasksApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getTaskComments: builder.query({
      ...
      providesTags: (result, error, task_pk) => [{ type: 'TaskComments', id: task_pk }],
    }),
    ...
    getTaskAttachments: builder.query({
      ...
      providesTags: (result, error, task_pk) => [{ type: 'TaskAttachments', id: task_pk }],
    }),
    ...
    getTaskStatusHistory: builder.query({
      ...
      providesTags: (result, error, task_pk) => [{ type: 'TaskStatusHistory', id: task_pk }],
    }),
    ...
    getTaskTimeLogs: builder.query({
      ...
      providesTags: (result, error, task_pk) => [{ type: 'TaskTimeLogs', id: task_pk }],
    }),
  }),
});
