    ...
    <div className="min-h-screen bg-gray-50  flex flex-col items-center gap-2 justify-center px-4">
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-xl">
        ...
        <div className="mt-6">
          <div className="flex items-center mb-2">
            ...
            <p className="mx-4 text-center text-sm text-gray-500 whitespace-nowrap">
              Try Demo Accounts
            </p>
            <div className="flex-grow border-t border-gray-300"></div>
          </div>
          ...
          <div className="space-y-3 text-sm">
            ...
            <div className="flex items-center mt-6 mb-2">
              <img height="15.5px" width="15.5px" src="images/employee.png" alt="Employee Icon" />
              <span className="font-semibold text-gray-900 ml-2">Administrative Access</span>
              <div className="ml-auto">
                <img width="15.5px" height="15.5px" src="images/info.png" alt="info" />
              </div>
            </div>
            ...
            <div className="border border-teal-400 rounded-md p-3 flex justify-between items-center text-teal-600  cursor-pointer">
              <div className="flex items-center space-x-2">
                <img width="15.5px" height="15.5px" src="/images/Vector.png" />
            ...
            <div className="flex items-center mt-6 mb-2">
              <img height="15.5px" width="15.5px" src="images/employee.png" alt="Employee Icon" />
              <span className="font-semibold text-gray-900 ml-2">Employee Access</span>
              <div className="ml-auto">
                <img width="15.5px" height="15.5px" src="images/info.png" alt="info" />
              </div>
            </div>
            ...
            <div className="border border-orange-400 rounded-md p-3 flex justify-between items-center text-orange-600 cursor-pointer">
              <div className="flex items-center space-x-2">
                <img height="19.4px" width="19.4px" src="images/employee_demo.png" />
        ...
        <div className="mt-8 p-4 bg-teal-50 rounded-lg border border-teal-200">
          <div className="flex items-center space-x-2 mb-2 text-black-600 font-semibold">
            <img width="19.5px" height="19.5px" src="/images/Frame.png" alt="Unified icon" />
            <span>Unified Access Portal</span>
          </div>
          <div className="text-sm text-gray-700 space-y-2">
            <p>
              <strong>Admin Users:</strong> Comprehensive system control, user management,
              performance metrics
            </p>
            <p>
              <strong>Employees:</strong> My Dashboard, task management, vacation requests, skill
              development
            </p>
          </div>
      ...
      <div className="mt-10 flex justify-center items-center space-x-6 text-sm text-gray-500">
        <div className="flex items-center space-x-1">
          <img width="15.4px" height="15.4px" src="images/enterprise.png" alt="enterprise" />
      ...
      <p className="mt-4 mb-6 text-center text-base text-gray-600 font-medium">
