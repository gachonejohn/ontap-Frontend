      ...
      <div className="bg-white rounded-md p-6 w-[400px] relative shadow-lg">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <span
            ...
            style={{
              backgroundColor: payroll.status === 'Processed' ? '#17ae93' : '#facc15',
              color: payroll.status === 'Processed' ? '#fff' : '#000',
            }}
          >
            {payroll.status}
          </span>
        ...
        <div className="flex justify-end mt-2">
          ...
          >
            <img src="/images/new_download.png" alt="Download Payslip" className="w-4 h-4" />
            Download Payslip
          </button>
        </div>
      </div>
