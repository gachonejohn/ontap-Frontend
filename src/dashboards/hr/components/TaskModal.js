      ...
      <div className="relative mt-12 bg-white rounded-2xl w-[560px] max-h-[90vh] overflow-y-auto shadow-lg p-6">
        ...
        <div className="flex flex-col justify-start items-start gap-4 mb-3">
          ...
          <div className="flex flex-row justify-start items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                <div className="flex flex-row justify-center items-center gap-1.5 py-2 px-3 h-8">
                  <div className="text-xs text-neutral-900 font-semibold">{currentStatus}</div>
            ...
            {/* Priority Badge */}
            <div
              className={`flex flex-row justify-center items-center gap-2.5 py-1 px-5 rounded-md h-9 ${
                task.priority === 'High'
            ...
            >
              <div className="text-[10px] font-medium">{task.priority} Priority</div>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-start items-start gap-5">
            ...
            <div className="flex flex-col justify-start items-start gap-4 w-[307px]">
              ...
              <div className="flex flex-col justify-start items-start gap-3">
                ...
                <div className="rounded-xl border border-stone-300 w-full p-3 bg-slate-50/80">
                  <div className="text-xs text-gray-600 font-medium">{task.description}</div>
                </div>
              </div>
                    ...
                    >
                      <div className="flex flex-row justify-between items-center w-full">
                        <div className="flex flex-col justify-start items-start">
                          <div className="text-xs font-medium text-neutral-900">{att.name}</div>
                          <div className="text-[10px] text-gray-600 font-medium">{att.size}</div>
                        </div>
              ...
              <div className="flex flex-col justify-center items-center rounded-xl border border-stone-300 w-full p-3 bg-slate-50/80">
                <div className="flex flex-col justify-start items-start gap-3 w-full">
                  <div className="flex flex-row justify-between items-center w-full">
                    ...
                    <div className="text-xs text-gray-600 font-medium">{task.assignee}</div>
                  </div>
                  <div className="flex flex-row justify-between items-center w-full">
                    <div className="text-xs text-gray-600 font-medium">Team</div>
                    <div className="text-xs text-gray-600 font-medium">{task.team}</div>
                  </div>
                  <div className="flex flex-row justify-between items-center w-full">
                    <div className="text-xs text-gray-600 font-medium">Priority</div>
                    <div className="text-xs text-gray-600 font-medium">{task.priority}</div>
                  </div>
                  <div className="flex flex-row justify-between items-center w-full">
                    <div className="text-xs text-gray-600 font-medium">Start Date</div>
                    <div className="text-xs text-gray-600 font-medium">{task.startDate}</div>
                  </div>
                  <div className="flex flex-row justify-between items-center w-full">
                    <div className="text-xs text-gray-600 font-medium">Due Date</div>
                    <div className="text-xs text-gray-600 font-medium">{task.dueDate}</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Comments Section */}
          <div className="flex flex-col justify-start items-start gap-3 w-full">
            <div className="text-sm font-semibold text-neutral-900">Comments</div>
            <div className="flex flex-col justify-center items-center rounded-lg w-full p-3 bg-gray-50">
              <div className="flex justify-start items-center w-full p-3 rounded-md bg-gray-100/80">
                <div className="text-sm text-gray-600 font-normal">Add a comment.....</div>
              </div>
            </div>

            {/* Existing Comments */}
            {task.comments && (
              <div className="text-xs text-gray-600 font-normal w-full mt-2">{task.comments}</div>
            )}
          </div>
        </div>
      </div>
