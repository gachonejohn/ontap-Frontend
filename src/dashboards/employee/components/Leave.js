    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-4 gap-4 w-full items-center">
        ...
        <div className="flex flex-col justify-between p-4 rounded-xl h-[120px] shadow-lg bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
          ...
          <div className="text-lg text-neutral-900 font-semibold">6h 45m</div>
        </div>
        ...
        <div className="flex flex-col justify-between p-4 rounded-xl h-[120px] shadow-lg bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
          ...
          <div className="text-lg text-teal-500 font-semibold">Present</div>
        </div>
      ...
      <div className="flex rounded-lg border border-slate-100 h-10 bg-slate-50 overflow-hidden">
        ...
        >
          <div
            className={`text-xs text-neutral-900 ${activeTab === 'leaveManagement' ? 'font-semibold' : 'font-medium'}`}
          >
            Leave Management
          </div>
        </div>
        ...
        >
          <div
            className={`text-xs text-neutral-900 ${activeTab === 'leaveBalance' ? 'font-semibold' : 'font-medium'}`}
          >
            Leave Balance
          </div>
        </div>
