            ...
            <div className="flex flex-col justify-between p-4 rounded-xl h-[120px] shadow-lg bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <div className="mt-2 text-lg text-neutral-900 font-semibold">6</div>
                  <div className="mt-1 text-xs text-gray-600 font-normal">New announcements</div>
                </div>
            ...
            <div className="flex flex-col justify-between p-4 rounded-xl h-[120px] shadow-lg bg-white transition-transform duration-200 hover:-translate-y-1 hover:shadow-xl">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <div className="mt-1 text-xs text-gray-600 font-normal">This Week</div>
                </div>
            ...
            <div className="flex flex-col p-4 rounded-xl w-full shadow-sm bg-white">
              <div className="flex justify-between items-start mb-3">
                ...
                <div className="flex items-center gap-2">
                  <div className="text-sm text-neutral-900 font-semibold">General Tech Meeting</div>
              ...
              <div className="text-xs text-gray-600 font-normal mb-3 line-clamp-2">
                ...
                during their first week: - Sarah Johnson (Marketing) - Mike Chen (Engineering) -
                Lisa Rodriguez (Sales) - David Kim (Product) - Emma Wilson (Design). Take a moment
                to introduce yourselves and offer any assistance as they settle in...
              </div>
