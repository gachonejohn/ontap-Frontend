    ...
    <div className="fixed inset-0 z-50 flex justify-center items-start bg-black/30 overflow-auto">
      <div className="relative mt-12 bg-white rounded-2xl w-[560px] max-h-[90vh] overflow-y-auto shadow-lg p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-lg text-neutral-900 font-semibold">Create Support Ticket</h2>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-2">
            <label className="text-sm text-neutral-900 font-medium">Issue Title</label>
            <input
              type="text"
              value={title}
          ...
          <div className="flex flex-row gap-4">
            <div className="flex flex-col gap-2 w-1/2">
              <label className="text-sm text-neutral-900 font-medium">Category</label>
              <select
                value={category}
