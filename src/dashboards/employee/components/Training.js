          ...
          <div className="flex flex-col justify-start items-start gap-6 flex-1 min-w-0">
            ...
            <div className="flex flex-col justify-start items-start w-full">
              <div className="flex flex-row justify-center items-center border border-slate-100 bg-slate-50 w-full overflow-x-auto">
                <div
                  className={`flex flex-row justify-center items-center gap-2 p-2 px-4 rounded-lg border-r border-slate-100 h-10 min-w-[201px] shrink-0 cursor-pointer ${courseDetailTab === 'overview' ? 'bg-white' : ''
                    }`}
                  onClick={() => setCourseDetailTab('overview')}
                >
                  <div className={`text-xs text-neutral-900 ${courseDetailTab === 'overview' ? 'font-semibold' : 'font-medium'
                    }`}>
                    Overview
                  </div>
                </div>
                <div
                  className={`flex flex-row justify-center items-center gap-2 p-2 px-4 h-10 min-w-[201px] shrink-0 cursor-pointer ${courseDetailTab === 'resources' ? 'bg-white' : ''
                    }`}
                  onClick={() => setCourseDetailTab('resources')}
                >
                  <div className={`text-xs text-neutral-900 ${courseDetailTab === 'resources' ? 'font-semibold' : 'font-medium'
                    }`}>
                    Resources
                  </div>
                </div>
                <div
                  className={`flex flex-row justify-center items-center gap-2 p-2 px-4 h-10 min-w-[201px] shrink-0 cursor-pointer ${courseDetailTab === 'notes' ? 'bg-white' : ''
                    }`}
                  onClick={() => setCourseDetailTab('notes')}
                >
                  <div className={`text-xs text-neutral-900 ${courseDetailTab === 'notes' ? 'font-semibold' : 'font-medium'
                    }`}>
                    Notes
                  </div>
                </div>
                <div
                  className={`flex flex-row justify-center items-center gap-2 p-2 px-4 h-10 min-w-[201px] shrink-0 cursor-pointer ${courseDetailTab === 'discussion' ? 'bg-white' : ''
                    }`}
                  onClick={() => setCourseDetailTab('discussion')}
                >
                  <div className={`text-xs text-neutral-900 ${courseDetailTab === 'discussion' ? 'font-semibold' : 'font-medium'
                    }`}>
                    Discussion
                  </div>
                </div>
                  ...
                  <>
                    ...
                    <div className="flex flex-col justify-start items-start gap-2 w-full">
                      ...
                      <div className="text-xs text-gray-600 font-medium">
                        ...
                        <br />
                        You'll learn about performance optimization, custom
                        hooks, testing strategies, and best practices for building
                          ...
                          <div className="flex flex-row justify-between items-center w-full">
                            ...
                            <div className="flex flex-row justify-center items-center gap-1 p-2 rounded-lg border border-neutral-200 h-9 min-w-[90px] cursor-pointer hover:bg-gray-50">
                              <div className="flex justify-center items-center h-4">
                                <img width="13px" height="13px" src="/images/download.png" alt="Download icon" />
                              </div>
                      ...
                      <div className="flex flex-col justify-start items-center gap-4 w-full">
                        ...
                        <div className="flex flex-row justify-start items-start gap-4 w-full">
                          ...
                          <div className="flex flex-col justify-start items-start gap-3 flex-1">
                            ...
                            <div className="text-xs text-gray-600 font-normal">
                              Great explanation of leadership overview! The examples really
                              helped me understand the concept better. The practical examples
                ...
                <div className="flex flex-col justify-start items-start gap-3 w-full">
                  <div className="flex flex-row justify-start items-center gap-4">
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-purple-50">
                      <div className="text-[10.5px] text-purple-900 font-semibold">
                        Business
                      </div>
                    </div>
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-green-100">
                      <div className="text-[10.5px] text-green-800 font-semibold">
                        Beginner
                      </div>
                    </div>
                  </div>
                ...
                <div className="flex flex-col justify-start items-start gap-3 w-full">
                  <div className="flex flex-row justify-start items-center gap-4">
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-blue-50">
                      <div className="text-[10.5px] text-blue-900 font-semibold">
                        Data
                      </div>
                    </div>
                ...
                <div className="flex flex-col justify-start items-start gap-3 w-full">
                  <div className="flex flex-row justify-start items-center gap-4">
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-pink-50">
                      <div className="text-[10.5px] text-pink-900 font-semibold">
                        Design
                      </div>
                    </div>
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-green-100">
                ...
                <div className="flex flex-col justify-start items-start gap-3 w-full">
                  <div className="flex flex-row justify-start items-center gap-4">
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-orange-50">
                      <div className="text-[10.5px] text-orange-900 font-semibold">
                        Development
                      </div>
                    </div>
                    <div className="flex flex-row justify-center items-center gap-2.5 py-0.5 px-5 rounded-md h-5 bg-red-100">
                      <div className="text-[10.5px] text-red-800 font-semibold">
                        Advanced
                      </div>
                    </div>
                  </div>
