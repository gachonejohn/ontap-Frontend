        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <div className="mt-2 text-lg text-neutral-900 font-semibold">{metrics.total}</div>
            </div>
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <div className="mt-2 text-lg text-neutral-900 font-semibold">{metrics.active}</div>
            </div>
        ...
        >
          <div className="flex justify-between items-center">
            <div className="flex flex-col">
              ...
              <div className="mt-2 text-lg text-neutral-900 font-semibold">{metrics.onLeave}</div>
            </div>
