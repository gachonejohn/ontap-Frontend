...
const RecentEmployees = () => {
  ...
  return (
    <>
      {/* Employee Table */}
      <div className="rounded-xl shadow-sm bg-white border overflow-hidden w-full">
        {/* Table Header */}
        <div className="flex flex-row justify-between items-center p-4 w-full h-14 ">
          ...
          bg-amber-100 border-amber-500text-xs fonte-medium text-amber-500 focus:ring-1 focus:ring-amber-500 hover:text-white hover:bg-amber-500"
            >
              View all
            </div>
          </div>
