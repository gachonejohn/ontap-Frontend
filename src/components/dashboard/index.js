        ...
        <>
             ...
             bg-white transition-transform duration-200 hover:-translate-y-1 shadow-sm border hover:shadow-md">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <div className="mt-2 text-lg text-neutral-900 font-semibold">{employeesData?.count ?? 0}</div>
             ...
             bg-white transition-transform duration-200 hover:-translate-y-1 shadow-sm border hover:shadow-md">
              <div className="flex justify-between items-center">
                <div className="flex flex-col">
                  ...
                  <div className="mt-2 text-lg text-neutral-900 font-semibold">{hiresThisMonth}</div>
                  <div className="mt-1 text-xs text-gray-600 font-normal">
                    {hiresDiff >= 0 ? `+${hiresDiff}` : hiresDiff} vs last month
                  </div>
                </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 w-full">
            ...
            <div className="flex flex-col gap-4 p-4 rounded-xl shadow-sm bg-white w-full lg:w-[300px]">
              ...
              {leaveRequests.map((req, index) => (
                <div key={index} className="flex flex-col gap-3 p-3 rounded-lg border border-gray-200">
                  <div className="flex justify-between items-center">
                    <div className="text-sm text-neutral-900 font-medium">{req.name}</div>
                    <span className="px-2 py-1 rounded-md bg-gray-100 text-xs text-gray-700">{req.days}</span>
                  </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 w-full">
            <div className="flex flex-col gap-4 p-4 rounded-xl shadow-sm bg-white">
              <div className="text-lg text-neutral-900 font-semibold">Task Completion by Department</div>
            ...
            <div className="flex flex-col gap-4 p-4 rounded-xl shadow-sm bg-white">
              ...
              <div className="flex justify-center">
                <TrainingProgressChart data={trainingData} onSegmentClick={handleTrainingSegmentClick} />
              </div>
            ...
            <div className="flex flex-col gap-4 p-4 rounded-xl shadow-sm bg-white">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={index} className="p-3 rounded-lg bg-gray-50 border border-gray-200 hover:bg-gray-100 cursor-pointer">
                ...
                <table className="w-full text-sm text-left">
                  ...
                  <tbody>
                    <tr className="border-b">
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 rounded-full bg-black text-white text-xs">Issued</span>
                      </td>
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 rounded-full bg-black text-white text-xs">Issued</span>
                      </td>
                      <td className="py-3 px-4"><ActionsDropdown /></td>
                    </tr>
                    <tr className="border-b">
                      <td className="py-3 px-4">
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 rounded-full bg-gray-200 text-gray-700 text-xs">Pending</span>
                      </td>
                      <td className="py-3 px-4"><ActionsDropdown /></td>
                    </tr>
                    <tr>
                      ...
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 rounded-full bg-red-600 text-white text-xs">Revoked</span>
                      </td>
                      <td className="py-3 px-4">
                        <span className="px-2 py-1 rounded-full bg-black text-white text-xs">Issued</span>
                      </td>
