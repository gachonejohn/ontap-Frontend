...
import { createDeptAdjustmentSchema } from '@schemas/payroll.Schema';
...
export const CreateDepartmentAdjForm = ({ onClose, refetchData }) => {
  ...
  const {
    ...
    resolver: zodResolver(createDeptAdjustmentSchema),
    defaultValues: {
        period:undefined,
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      const message = getApiErrorMessage(error, 'Error creating adjustments.');
      toast.error(message);
    } finally {
      refetchData();
    }
