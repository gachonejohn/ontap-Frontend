...
export const NewTemplate = ({ refetchData }) => {
  ...
  const onSubmit = async (formData) => {
    try {
      ...
      const message = getApiErrorMessage(error, 'Error Template.');
      toast.error(message);
    } finally {
      refetchData();
    }
  ...
  const handleTypeChange = (selected) => {
    setValue('template_type', selected ? selected.value : '');
  };
          ...
          <div className="fixed inset-0 min-h-full z-50 w-screen flex flex-col text-center md:items-center justify-center overflow-y-auto p-2 md:p-3 pointer-events-none">
            ...
            >
              <div className="sticky top-0 bg-white z-40 flex px-4 justify-between items-center py-4">
                <p className="text-sm md:text-lg lg:text-lg font-semibold">Add New Template</p>
                ...
                <div>
                  ...
                  <div className="">
                    ...
                    {errors.template_type && (
                      <p className="text-red-500 text-sm mt-1">{errors.template_type.message}</p>
                    )}
                  </div>
                </div>
                <div className="">
