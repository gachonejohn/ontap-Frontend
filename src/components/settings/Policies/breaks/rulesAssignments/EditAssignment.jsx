...
export const EditBreakTypePolicyAssignment = ({ data, refetchData }) => {
  ...
  const [updateBreakTypeAssignment, { isLoading: isCreating }] =
    useUpdateBreakTypeAssignmentMutation();
  ...
  const {
    ...
    defaultValues: {
      break_type: data?.break_type?.id ?? undefined,
      break_rule: data?.break_rule?.id ?? undefined,
      max_duration_minutes: data?.max_duration_minutes ?? 0,
  ...
  const onSubmit = async (formData) => {
    try {
      await updateBreakTypeAssignment({
        id: data.id,
        data: formData,
      }).unwrap();
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 p-4">
                ...
                <div className="">
                  ...
                  <Select
                    ...
                    defaultValue={{
                      label: data.break_type.name,
                      value: data.break_type.id,
                    }}
                ...
                <div className="">
                  ...
                  <Select
                    ...
                    defaultValue={{
                      label: data.break_rule.name,
                      value: data.break_rule.id,
                    }}
                    menuPortalTarget={document.body}
                    menuPlacement="auto"
                    styles={{
